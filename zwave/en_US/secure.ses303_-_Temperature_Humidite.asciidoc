...
* 2: Permet de régler l'intervalle de temps d'envoie de la température à Jeedom (en minutes)
* 3: Permet de régler de combien doit varier l'humidité pour que le module l'envoie à Jeedom (par %)
* 4: Permet de régler l'intervalle de temps d'envoie de l'humidité à Jeedom (en minutes)

Tous les autres paramètres sont identiques et correspondent à chaque sondes externes éventuellement branchées
