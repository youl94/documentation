...
Vous recevrez un signal sonore au cas ou le statut de chargement des piles est trop faible.
...
* Serrure connectée
* 1 cylindre adaptable à différentes longueurs fournis
...
Pour mettre le plugin Z-Wave (openzwave) dans Jeedom en mode inclusion sécurisée : il suffit d'aller sur la page de gestion des modules Z-wave et de cliquer sur l'icône "reseau Zwave"
...
* 5 : Auto verrouillage 0-60 Combien de secondes à partir du moment où la serrure a été déverrouillés pour automatiquement se fermer à nouveau. Si 0, il est désactivé.
* 6 : son désactiver ou activer le signal sonore de verrouillage ou déverrouillage (0 = Désactiver, 1 = Activer.)
...
* 11 : Async 0 = Async off, 1 = Async On. Lorsqu’async est activé le verrou sera automatiquement calibré si elle est déjà déverrouillée et Déverrouille à nouveau (utilisé pour des serrures de porte spéciales).
