...
* Installer un nouveau Jeedom sur une nouvelle carte SD (Que cela soit pour mettre dans votre *Jeedom Esclave* existant ou pour un nouveau RaspberryPi) en suivant la https://jeedom.github.io/documentation/installation/fr_FR/doc-installation.html[documentation d'installation].
