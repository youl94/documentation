...
Normalement les paramètres d'ajout du protocole https sont ajouter par le script dans Apache.
...
Vous recevez un mail automatiquement à l'arrivée à échéance du certificat qui vous rappelera de passer la commande
