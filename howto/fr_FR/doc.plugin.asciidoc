...
Cette particularité permet d'ajouter des fonctions supplémentaires aux fonctions présentes dans l'AsciiDoc. Mais nécessite aussi une compilation particulière pour avoir une visibilité sur le rendu final. {nbsp} +
...
Il est possible d'inclure d'autres fichiers AsciiDoc.
