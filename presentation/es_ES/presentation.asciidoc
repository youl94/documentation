...
Alrededor de este núcleo se injertan plugins de cualquier tipo:
...
Estos plugins pueden ser devueltos a través del market y permiten ampliar las posibilidades de Jeedom.
