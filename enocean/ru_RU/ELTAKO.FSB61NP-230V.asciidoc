...
En effet, nous avons la possibilité de d'identifier si le volet est Entre-ouvert lors de la montée ou de la descente
...
* Sauver
* Cliquez sur la roue dentée (au bout de la ligne de notre Info Etat) pour ouvrir la fenêtre  de configuration de commande,
* dans l'onglet "Configuration Avancée", saisissez \#value# dans le champs "Formule de calcul (\#value# pour la valeur)" et 0 dans le champs "Arrondi (chiffre après la virgule)".
