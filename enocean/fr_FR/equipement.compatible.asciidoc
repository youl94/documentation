...
[green]*Actuellement Jeedom est compatible avec* [red]*7* [green]*marques de modules differentes, soit un total de* [red]*53* [green]*modules.*

D'autres modules non presents sur cette liste peuvent etre compatibles.
...
|image:../images/compatibility_list/d2-01-09_smartplug_ubiwizz_metering.jpg[width=150,align="center"]|UbiWizz|Smart Plug EnOcean|D2-01-09|Prise| |Jeedom en inclusion, puis appui long jusqua clignotement rouge puis relacher et rappuyer. Ensuite appui long jusqua clignotement rouge et relacher puis appuyer sur tester sur la commande ON| link:++http://www.domadoo.fr/fr/peripheriques/2667-ubiwizz-smart-plug-enocean-schuko.html++[Acheter^]
// 
